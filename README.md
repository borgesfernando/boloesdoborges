...
- O workflow `.github/workflows/update-mega-status.yml` faz uma recuperação diária às 06h BRT e, nas janelas críticas de apuração, a cada 5 minutos, de 10 minutos antes até 1 hora após o sorteio. O commit só ocorre se um snapshot realmente mudou.
