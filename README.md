...
- O workflow `.github/workflows/update-mega-status.yml` consulta a CAIXA a cada 30 minutos e, nas janelas críticas de apuração (20h50–23h30 BRT e domingo 10h50–12h30 BRT), a cada 5 minutos. O commit só ocorre se um snapshot realmente mudou.
